      ...
      <div className="max-w-screen-lg mx-auto text-center bg-white shadow-lg rounded-lg p-6 sm:p-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg sm:text-xl text-gray-600 font-Roboto">
            Discover the latest trends and styles in womens fashion. Our curated collection offers a wide range of stylish clothing that fits every occasion, from casual to formal wear. 
